...
const IRT_C_GUESS = 0.08;  // v1.2: снижено с 0.12 — ещё жёстче штраф за угадывание
const SCORING_MODEL_VERSION = "1.2";

function difficultyToB(difficulty) {
  const d = difficulty || 3;
  return (d - 3) * 1.6; // v1.2: увеличен множитель с 1.2 — ещё сильнее разносит лёгкие/сложные вопросы
}
